...
python3 code/preprocess_eval.py --yolact=True --images_dir=/cluster/project/infk/cvg/heinj/datasets/bop/mvpsp --preds_path=/cluster/project/infk/cvg/heinj/students/kbirgi/BachelorThesis/Annotations/quant_eval_trials_nogt/preds/yolact/pbr_ref_all_26000 --bbox_preds=pbr_with_real_all_bbox_detections.json --mask_preds=pbr_with_real_all_mask_detections.json --labels_path=/cluster/project/infk/cvg/heinj/students/kbirgi/BachelorThesis/Annotations/quant_eval_trials_nogt/amodal_labels_150.json --output=yolact/pbr_ref_all_26000 --save_images=False
