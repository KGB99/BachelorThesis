...
def create_labels_from_old_annotations(args):
    output_dir = args.output_dir
    coco_dir = args.coco_file
    train_ratio = args.train_ratio
    val_folders = args.val_folders
...
if __name__ == "__main__":
    ...
    parser.add_argument("--old_annotations", required=False, default=False, type=bool)
    
    args = parser.parse_args()

    if args.old_annotations:
        create_labels_from_old_annotations(args)
    else:
        create_labels(args)
